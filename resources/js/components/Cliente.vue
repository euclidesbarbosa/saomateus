<template>
    <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a :class="(tab4 ? 'nav-link active' : 'nav-link')" id="pesquisa-tab" data-toggle="tab" href="#home" role="tab"
                   aria-controls="pesquisa" aria-selected="{{tab4}}" @click="getTab(4)">Acompanhamento</a>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            ...
            <div v-show="tab4" ref="pesquisa-tab"
...
<script>
    ...
    export default {
        ...
        components:{
            AtendimentoPesquisa,
            Atendimento,
            ClienteCenso, ClienteContato, ClienteDoc, Unico
        },
        data(){
            return{
                atendimentoArr:{
